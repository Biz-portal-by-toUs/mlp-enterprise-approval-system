...
public class CommentController {
    ...
    public ResponseEntity<ResponseDto<CommentDto>> getComment(@PathVariable("commentNo") Long commentNo) {
    ...
    public ResponseEntity<String> delete(@PathVariable("commentNo") Long commentNo) {
