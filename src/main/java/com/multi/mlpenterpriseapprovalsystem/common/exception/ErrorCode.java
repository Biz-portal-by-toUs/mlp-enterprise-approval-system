...
public enum ErrorCode {
    ...
    DOCUMENT_FORM_EDIT_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "DOCUMENT_FORM_EDIT_ALREADY_EXISTS", "이미 수정 중인 양식입니다."),
    ...
    MEETING_ROOM_RESERVATION_NOT_FOUND(HttpStatus.NOT_FOUND, "MEETING_ROOM_RESERVATION_NOT_FOUND", "회의실 예약을 찾을 수 없습니다"),
    MEETING_ROOM_RESERVATION_ACCESS_DENIED(HttpStatus.FORBIDDEN, "MEETING_ROOM_RESERVATION_ACCESS_DENIED", "해당 예약을 취소할 권한이 없습니다"),
    MEETING_ROOM_RESERVATION_DELETE_CONFLICT(HttpStatus.CONFLICT, "MEETING_ROOM_RESERVATION_DELETE_CONFLICT", "연관 데이터가 남아 있어 예약을 취소할 수 없습니다"),
